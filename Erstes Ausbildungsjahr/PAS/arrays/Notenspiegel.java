...
public class  Notenspiegel {
    public static void main(String[] args) {
        ...
        //ausgabe
        int notendurchschnitt = (notenanzahl[0] * 1 + notenanzahl[1] * 2 + notenanzahl[2] * 3 + notenanzahl	[3] * 4 + notenanzahl[4] * 5 + notenanzahl[5] * 6) / (notenanzahl[0] + notenanzahl[1] + notenanzahl[2] + notenanzahl[3] + notenanzahl[4] + notenanzahl[5]);
