...
const uuid_1 = require("uuid"); // For version 5
class ARMExpressionParser {
    ...
    eval(exp, check = false) {
        ...
        if (match) {
            ...
            if (funcName === 'resourceGroup' && funcProps === '.id') {
                return '{res-group-id}';
            }
            if (funcName === 'resourceGroup' && funcProps === '.location') {
                return '{res-group-location}';
            }
            if (funcName === 'subscription' && funcProps === '.subscriptionid') {
                return '{subscription-id}';
            }
            if (funcName === 'deployment' && funcProps === '.name') {
        ...
        if (match) {
            ...
            if (funcName === 'guid') {
                return uuid_1.v5(this.funcConcat(funcParams, ''), '36c56b01-f9c9-4c7d-9786-0372733417ea');
            }
        }
    ...
    //
    funcVarParam(source, varName, propAccessor) {
...
exports.default = ARMExpressionParser;
//# sourceMappingURL=arm-exp-parser.js.map