...
const bazel_goto_definition_provider_1 = require("../definition/bazel_goto_definition_provider");
...
function activate(context) {
    ...
    const completionItemProvider = new completion_provider_1.BazelCompletionItemProvider();
    // tslint:disable-next-line:no-floating-promises
    completionItemProvider.refresh();
    context.subscriptions.push(vscode.languages.registerCompletionItemProvider([{ pattern: "**/BUILD" }, { pattern: "**/BUILD.bazel" }], completionItemProvider, "/", ":"), vscode.window.registerTreeDataProvider("bazelWorkspace", workspaceTreeProvider), 
    // Commands
    ...
    vscode.languages.registerDefinitionProvider([{ pattern: "**/BUILD" }, { pattern: "**/BUILD.bazel" }], new bazel_goto_definition_provider_1.BazelGotoDefinitionProvider()), 
    // Task events.
...
function bazelBuildTarget(adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        if (adapter === undefined) {
            ...
            // try again.
            if (quickPick) {
                yield bazelBuildTarget(quickPick);
            }
            return;
        }
...
function bazelBuildTargetWithDebugging(adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        if (adapter === undefined) {
            ...
            // try again.
            if (quickPick) {
                yield bazelBuildTargetWithDebugging(quickPick);
            }
            return;
        }
...
function bazelbuildAll(adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        yield buildPackage(":all", adapter);
    });
}
/**
...
function buildPackage(suffix, adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        if (adapter === undefined) {
            ...
            // try again.
            if (quickPick) {
                yield buildPackage(suffix, quickPick);
            }
            return;
        }
        const commandOptions = adapter.getBazelCommandOptions();
...
function bazelTestTarget(adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        if (adapter === undefined) {
            ...
            // try again.
            if (quickPick) {
                yield bazelTestTarget(quickPick);
            }
            return;
        }
        const commandOptions = adapter.getBazelCommandOptions();
...
function testPackage(suffix, adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        if (adapter === undefined) {
            ...
            // try again.
            if (quickPick) {
                yield testPackage(suffix, quickPick);
            }
            return;
        }
        const commandOptions = adapter.getBazelCommandOptions();
