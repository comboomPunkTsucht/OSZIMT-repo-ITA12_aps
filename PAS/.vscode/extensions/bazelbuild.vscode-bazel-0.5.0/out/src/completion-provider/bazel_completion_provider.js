...
function insertCompletionItemIfUnique(options, option) {
...
function getCandidateTargetFromDocumentPosition(document, position) {
...
function stripLastPackageOrTargetName(target) {
...
function getNextPackage(target) {
...
class BazelCompletionItemProvider {
    constructor() {
        this.targets = [];
    }
    /**
    ...
    provideCompletionItems(document, position) {
        let candidateTarget = getCandidateTargetFromDocumentPosition(document, position);
        ...
        this.targets.forEach((target) => {
            ...
            insertCompletionItemIfUnique(completionItems, new vscode.CompletionItem(label, completionKind));
        });
    ...
    refresh() {
        return __awaiter(this, void 0, void 0, function* () {
            const queryTargets = yield bazel_1.queryQuickPickTargets("kind('.* rule', ...)");
...
exports.BazelCompletionItemProvider = BazelCompletionItemProvider;
//# sourceMappingURL=bazel_completion_provider.js.map