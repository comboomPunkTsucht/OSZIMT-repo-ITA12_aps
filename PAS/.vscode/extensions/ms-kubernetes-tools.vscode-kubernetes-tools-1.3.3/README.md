...
**What's new in this version?**  See the [change log](https://github.com/Azure/vscode-kubernetes-tools/blob/HEAD/CHANGELOG.md) to find out!
...
See the [change log](https://github.com/Azure/vscode-kubernetes-tools/blob/HEAD/CHANGELOG.md).
...
If you are building and running the extension from source, see [CONTRIBUTING.md](https://github.com/Azure/vscode-kubernetes-tools/blob/HEAD/CONTRIBUTING.md) for prerequisites for the development environment.
...
For technical information about contributing, see [CONTRIBUTING.md](https://github.com/Azure/vscode-kubernetes-tools/blob/HEAD/CONTRIBUTING.md).
