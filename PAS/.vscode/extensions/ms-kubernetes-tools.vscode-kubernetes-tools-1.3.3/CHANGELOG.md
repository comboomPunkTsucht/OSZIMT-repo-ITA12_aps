...
* Added basic Python debugging support.  See [the debugging documentation](https://github.com/Azure/vscode-kubernetes-tools/blob/HEAD/debug-on-kubernetes.md)
...
* We now offer an API for adding your features to the extension!  See the
  [API documentation](https://github.com/Azure/vscode-kubernetes-tools/blob/HEAD/docs/extending/) for more information, and use the
