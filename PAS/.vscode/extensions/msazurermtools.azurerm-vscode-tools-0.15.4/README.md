...
![Image showing the arm template scaffolding snippet](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/json-snippets.png)
...
![Image showing that the language type has changed to Azure Resource Manager Template](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/arm-template-language.png)
...
![Image showing a storage account being added with a snippet](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/arm-snippets.png)
...
![Image showing snippet tab stops with pre-populated parameter values](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/tab-stops.gif)
...
![Image showing a list of storage account tier values returned from the storage Azure schema](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/completion.png)
...
![Image showing a schema validation error](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/schema-validation.png)
...
![Image showing the code lens for creating a parameter file association](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/create-parameter-file.png)

Select **New** from the context menu.

![Image showing the parameter file creation options (none, new, and browse)](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/create-parameter-file-2.png)
...
![Image showing options for adding parameters for parameter file (All parameters, only required parameters)](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/create-parameter-file-3.png)

Select a name and location for the parameter file.

![Image showing a file save as dialog box](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/create-parameter-file-4.png)

Once done, a parameter file has been created. Where needed, remove the _TODO_ comment and add a parameter value.

![Image showing new parameter file](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/parameter-file.png)
...
![Image showing that the parameter code lens has been updated to reflect associated parameter file](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/code-lens.png)
...
![Image showing a parameter validation issue](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/param-file-validation.png)
...
![Image showing the light bulb helper for adding missing parameters](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/missing-params-one.png)

Select the option to add only required or all missing parameters.

![Image showing missing parameter options (Add missing required parameters, Add all missing parameters)](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/missing-params-two.png)

Enter a value for the added parameters and also remove the 'TODO' comment.

![Image showing parameter file after missing parameters have been added](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/missing-params-three.png)
...
![Image showing the rename parameter dialoug](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/rename-parameter.png)

### Remove or update parameter file association

Click on the code lens option for changing a parameter association.

![Image showing the code lens for creating a parameter file association](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/undo-change-mapping.png)
...
![Image showing the parameter file creation options (none, new, and browse)](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/undo-change-mapping-two.png)
...
![Image showing the ARM template outline with a storage account resource selected](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/arm-template-outline.png)
...
![Image showing the Go to Definition dialog on a parameter reference](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/go-to-definition.png)
...
![Image showing the go to reference user interface](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/parameter-references.png)
...
![Inserting an item into an Azure Resource Manager template](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/insert-item.png)

You can also right-click on any element in the ARM Template Outline view to initiate the insert item process.

![Inserting an item into an Azure Resource Manager template](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/insert-item-outline.png)
...
![Image showing the sort template options (Resource, Function, Output, Parameter, Variable)](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/sort-template.png)

Select the element that you want to sort.

![Image showing the insert resource menu](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/sort-template-two.png)
...
![Image demonstrating extracting a variable and a parameter](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/extract-vars-and-params.gif)

*Thanks to Nils Hedström [@nilshedstrom](https://github.com/nilshedstrom) for implementing this feature!*

### Hover to format complex expressions or multi-line strings

![Image showing hovering over an expression](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/hover-to-format-expression.png)

![Image showing hovering over a multi-line string](https://github.com/Microsoft/vscode-azurearmtools/raw/main/./images/hover-to-format-string.png)
...
The source code in our [public repository](https://github.com/Microsoft/vscode-azurearmtools) is licensed under the [MIT license](https://github.com/Microsoft/vscode-azurearmtools/blob/main/LICENSE.md) and may be locally built and used in accordance with this license.
