...
exports.getThreePageBranchWorkflowSampleWizardWithValidation = exports.demonstrateSinglePageAllControls = exports.getTwoPageLinearSampleWizardWithValidation = void 0;
const vscode = __importStar(require("vscode"));
const WebviewWizard_1 = require("./WebviewWizard");
function getTwoPageLinearSampleWizardWithValidation(context) {
    let def = {
    ...
    const wiz = new WebviewWizard_1.WebviewWizard("sample1", "sample1", context, def, data);
    return wiz;
}
exports.getTwoPageLinearSampleWizardWithValidation = getTwoPageLinearSampleWizardWithValidation;
function demonstrateSinglePageAllControls(context) {
    let def = {
    ...
    const wiz = new WebviewWizard_1.WebviewWizard("sample3", "sample3", context, def, new Map());
    return wiz;
}
exports.demonstrateSinglePageAllControls = demonstrateSinglePageAllControls;
function getThreePageBranchWorkflowSampleWizardWithValidation(context) {
    let def = {
    ...
    const wiz = new WebviewWizard_1.WebviewWizard("sample1", "sample1", context, def, new Map());
    return wiz;
}
exports.getThreePageBranchWorkflowSampleWizardWithValidation = getThreePageBranchWorkflowSampleWizardWithValidation;
