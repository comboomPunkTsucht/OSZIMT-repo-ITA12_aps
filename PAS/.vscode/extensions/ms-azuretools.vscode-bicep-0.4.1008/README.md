...
The [bicep VS Code extension](https://github.com/Azure/bicep/blob/main/docs/installing.md#install-the-bicep-vs-code-extension) is capable of many of the features you would expect out of other language tooling. Here is a comprehensive list of the features that are currently implemented.
...
See [Bicep Type System](https://github.com/Azure/bicep/blob/main/docs/spec/types.md) for more information about Bicep data types and the type validation rules.
...
![intellisense being displayed for property access of a bicep resource](https://github.com/Azure/bicep/raw/main/docs/images/resource-dot-property-intellisense.gif)
...
![intellisense being displayed for available property names and property values where applicable of a bicep resource](https://github.com/Azure/bicep/raw/main/docs/images/resource-property-names-and-values.gif)
...
![intellisense being displayed for all available types for a resource](https://github.com/Azure/bicep/raw/main/docs/images/list-types-intellisense.gif)
...
![snippets for top level keywords](https://github.com/Azure/bicep/raw/main/docs/images/snippets.gif)
...
![navigating from parameter used as a property value to the parameter declaration](https://github.com/Azure/bicep/raw/main/docs/images/go-to-def.gif)

### Find all references, peek references

![showing all times a particular symbol is referenced](https://github.com/Azure/bicep/raw/main/docs/images/show-all-references.gif)

### Outline view and breadcrumb view

![screenshot of vs code with the Outline panel and breadcrumb highlighted](https://github.com/Azure/bicep/raw/main/docs/images/outline-and-breadcrumb.PNG)
...
![showing the cursor on a symbol and the other references that are automatically highlighted](https://github.com/Azure/bicep/raw/main/docs/images/highlights.gif)

### Hovers

![showing the mouse hovering over a symbol, which shows type information on a pop-up window](https://github.com/Azure/bicep/raw/main/docs/images/hovers.gif)
...
![rename a symbol called 'pip' into a symbol named 'publicIp' with the 'Rename symbol' feature](https://github.com/Azure/bicep/raw/main/docs/images/rename-symbol.gif)
...
![formatting a bicep file that is disorganized](https://github.com/Azure/bicep/raw/main/docs/images/format.gif)
...
![correcting a spelling error with "quick fix"](https://github.com/Azure/bicep/raw/main/docs/images/quick-fix.gif)
