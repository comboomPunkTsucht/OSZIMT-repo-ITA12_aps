...
CREATE    TABLE IF NOT EXISTS 'reperatur_t' (
          ...
          CONSTRAINT 'f_rahmen_nr' FOREIGN KEY ('f_rahmen_nr') REFERENCES 'fahrad_t' ('p_fahrad_nr') ON UPDATE CASCADE
          ) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE    TABLE IF NOT EXISTS 'rechnung_t' (
          ...
          PRIMARY KEY ('p_rechnungs_nr')                                                                                        ,
          CONSTRAINT 'f_material_nr' FOREIGN KEY ('f_material_nr') REFERENCES 'material_t' ('p_material_nr') ON UPDATE NO ACTION,
